    ...
    <section id="contact" className="py-24 bg-beige">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-2xl font-display font-bold text-text-dark mb-8">Connect With Me</h3>

            <div className="space-y-6">
              <a
                href="mailto:samidires12@gmail.com"
                className="flex items-center gap-4 text-text-dark hover:text-sage transition-colors group"
              >
                <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center group-hover:bg-sage transition-colors shadow-elegant">
                  <Mail className="w-6 h-6 text-taupe group-hover:text-white" />
                </div>
                <div>
                  <p className="font-semibold text-text-dark">Email</p>
                  <p className="text-sm text-text-dark/60">samidires12@gmail.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <p className="font-semibold text-text-dark">LinkedIn</p>
                  <p className="text-sm text-text-dark/60">Samuel Dires</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-text-dark/60">@yourusername</p>
                </div>
              </a>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-2xl font-display font-bold text-text-dark mb-8">Send a Message</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <input
                  ...
                  className="w-full px-4 py-3 bg-white border border-slate-light rounded-lg text-text-dark placeholder-text-dark/40 focus:outline-none focus:border-sage focus:ring-2 focus:ring-sage/20 transition-colors"
                  required
                  disabled={isSending}
                />
              </div>
              ...
              <div>
                <textarea
                  ...
                  onChange={handleChange}
                  rows={5}
                  className="w-full px-4 py-3 bg-white border border-slate-light rounded-lg text-text-dark placeholder-text-dark/40 focus:outline-none focus:border-sage focus:ring-2 focus:ring-sage/20 transition-colors resize-none"
                  required
                  disabled={isSending}
                ></textarea>
              </div>
